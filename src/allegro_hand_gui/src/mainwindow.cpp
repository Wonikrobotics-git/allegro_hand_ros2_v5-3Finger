    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->SphereButton, &QPushButton::clicked, this, &MainWindow::SphericalHomeButton);
...
void MainWindow::SphericalHomeButton()
{
    ...
    QString logMessage = QString("Spherical Home Position");
...
void MainWindow::SaveButton()
{
    ...
    std_msgs::msg::String msg;
    msg.data = "SavPos" + std::to_string(save_num_);
...
void MainWindow::MoveButton()
{
    ...
    // 메시지 생성
    std_msgs::msg::String msg;
    msg.data = "GoPos" + std::to_string(value); //
